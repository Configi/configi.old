...
T:start"test test/core-test.lua"
 do
   ...
   T:yes(lib.fwrite(tempname, "test"))
...
T:start"handler,notify test/core-handler.lua"
  do
    ...
    T:yes(lib.find_string(r.stdout, "Kept: true"))
...
T:start"each test/core-each.lua"
  do
    T:yes(stat.mkdir(testdir .. "core-each.xxx"))
    T:yes(stat.mkdir(testdir .. "core-each.yyy"))
...
T:start"textfile.insert_line_before (modules/textfile.lua) test/textfile_insert_line_before.lua"
  do
    ...
    T:eq(crc(lib.fopen("test/textfile_insert_line_before.txt")), crc(lib.fopen("test/tmp/textfile_insert_line_test.txt")))
 end
T:done(N)
...
T:start"textfile.insert_line_after (modules/textfile.lua) test/textfile_insert_line_after.lua"
  do
    ...
    T:eq(crc(lib.fopen("test/textfile_insert_line_after.txt")), crc(lib.fopen("test/tmp/textfile_insert_line_test.txt")))
...
T:start"textfile.remove_line (modules/textfile.lua) test/textfile_remove_line.lua"
 do
   ...
   T:eq(crc(lib.fopen("test/textfile_remove_line.txt")), crc(lib.fopen("test/tmp/textfile_remove_line_test.txt")))
...
T:start"file.link (modules/file.lua)"
  do
    ...
    T:eq(lib.execute("rm " .. testdir .. "file_link"), true)
  end
T:done(N)
...
T:start"file.hard (modules/file.lua)"
  do
    ...
    T:eq(lib.execute("rm " .. testdir .. "file_hard_src"), true)
    T:eq(lib.execute("rm " .. testdir .. "file_hard_link"), true)
  end
T:done(N)
