...
#endif
#ifdef lib_configi
extern int luaopen_cimicida(lua_State *L);
extern int luaopen_configi(lua_State *L);
extern int luaopen_px(lua_State *L);
extern int luaopen_px_c(lua_State *L);
extern int luaopen_factid(lua_State *L);
extern int luaopen_factid_c(lua_State *L);
extern int luaopen_crc32(lua_State *L);
...
const struct luaL_Reg lw_dependencies[] = {
	...
	#endif
	#ifdef lib_configi
	{.name = "cimicida", .func = luaopen_cimicida},
	{.name = "configi", .func = luaopen_configi},
	{.name = "px", .func = luaopen_px},
	{.name = "px_c", .func = luaopen_px_c},
	{.name = "factid", .func = luaopen_factid},
	{.name = "factid_c", .func = luaopen_factid_c},
	{.name = "crc32", .func = luaopen_crc32},
	{.name = "sha2", .func = luaopen_sha2},
	#endif
