...
# Created: Tue Jan 29 22:40:01 UTC 2019
#
#/ usage: cfg:fedora  --arg <> [ --comment <>] [ --verbose <>] [ --register <>] [ --requires <>]  --version <>  --manifest <>  --modules <> 
...
rerun_options_parse() {
    ...
    do
        ...
        case "$OPT" in
            ...
            --manifest) rerun_option_check $# $1; MANIFEST=$2 ; shift 2 ;;
            --modules) rerun_option_check $# $1; MODULES=$2 ; shift 2 ;;
            # help option
            -\?|--help)
                rerun_option_usage
                exit 2
    ...
    [[ -z "$MANIFEST" ]] && { echo >&2 "missing required option: --manifest" ; return 2 ; }
