...
# Created: Mon 11 Mar 2019 10:48:47 AM UTC
#
#/ usage: image:push  --arg <> [ --comment <>] [ --verbose <>] [ --register <>] [ --requires <>]  --host <> [ --unsigned <false>]  --image <> 
...
rerun_options_parse() {
    ...
    do
        ...
        case "$OPT" in
            ...
            --image) rerun_option_check $# $1; IMAGE=$2 ; shift 2 ;;
            # help option
            -\?|--help)
                rerun_option_usage
                exit 2
