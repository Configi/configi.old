...
# Created: Mon 11 Mar 2019 04:20:27 AM UTC
#
#/ usage: image:pull  --arg <> [ --comment <>] [ --verbose <>] [ --register <>] [ --requires <>]  --host <>  --creds <> [ --unsigned <false>] 
...
rerun_options_parse() {
    ...
    do
        ...
        case "$OPT" in
            ...
            --unsigned) rerun_option_check $# $1; UNSIGNED=$2 ; shift 2 ;;
            # help option
            -\?|--help)
                rerun_option_usage
                exit 2
    ...
    [[ -z "$UNSIGNED" ]] && UNSIGNED="$(rerun_property_get $RERUN_MODULE_DIR/options/unsigned DEFAULT)"
