...
# Created: Mon Jan 14 12:26:24 UTC 2019
#
#/ usage: buildah:config  --arg <> [ --comment <>] [ --verbose <>] [ --register <>]  --options <> 
...
rerun_options_parse() {
    ...
    do
        ...
        case "$OPT" in
            ...
            --options) rerun_option_check $# $1; OPTIONS=$2 ; shift 2 ;;
            # help option
            -\?|--help)
                rerun_option_usage
                exit 2
    ...
    [[ -z "$OPTIONS" ]] && { echo >&2 "missing required option: --options" ; return 2 ; }
