...
T:start"require test/core-require.lua"
    do
        local require = function(policy)
            ...
            T:neq(string.find(out.stderr[6], "%C+%c%C+%c%C+%c#nodeps"), nil)
            T:neq(string.find(out.stderr[7], "%C+%c%C+%c%C+%c#nodeps"), nil)
            T:neq(string.find(out.stderr[8], "%C+%c%C+%c%C+%c#delete%-nodeps"), nil)
            T:neq(string.find(out.stderr[9], "%C+%c%C+%c%C+%c#delete%-nodeps"), nil)
            T:neq(string.find(out.stderr[10], "%C+%c%C+%c%C+%c#last"), nil)
            T:neq(string.find(out.stderr[11], "%C+%c%C+%c%C+%c#last"), nil)
            T:neq(string.find(out.stderr[12], "%C+%c%C+%c%C+%c#delete%-last"), nil)
            T:neq(string.find(out.stderr[13], "%C+%c%C+%c%C+%c#delete%-last"), nil)
            T:neq(string.find(out.stderr[14], "%C+%c%C+%c%C+%c#4th"), nil)
            T:neq(string.find(out.stderr[15], "%C+%c%C+%c%C+%c#4th"), nil)
